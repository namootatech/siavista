...
const SellingPoints = () => {
  return (
    <Container id='selling-points' className='p-4 bg-dark-grey selling-points'>
      <Container className=' p-md-4 py-4'>
        <div className='m-md-4'>
          <Row className='p-md-4 py-4'>
            <Col lg={4} md={12} className='text-center p-md-4 py-4 '>
            ...
            <Col lg={4} md={12} className='text-center p-4 '>
              ...
              <p className='text-white fs-5 p-4'>
                {' '}
                We delve deep into understanding the specific requirements of
                each project, allowing us to deploy targeted solutions that
                address the core of your electrical challenges.
              </p>
            </Col>
            <Col lg={4} md={12} className='text-center p-4'>
              ...
              <p className='text-white fs-5 p-4'>
                ...
                electrical services and equipment that yield maximum
                functionality and longevity, all while maintaining an eye on
                cost-efficiency.
              </p>
            </Col>
          </Row>
