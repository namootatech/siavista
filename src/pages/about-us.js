              ...
              <Col lg={8} md={12} className='mt-2 mb-5 py-4'>
                <div id='history-section'>
                  ...
                  <p className='text-grey fs-3 my-4 lead'>
                    ...
                    companies, which was largely echoed by all our
                    organization&apos;s stakeholders which have impacted our
                    organization&apos;s growth and development through a journey
                  ...
                  <p className='text-grey fs-3 my-4 lead'>
                    ...
                    destroyed), fueled by a dream, creativity, hard word, and
                    determination, we transformed into Siavista. An aspirational
                    entity with a broader vision to utilize and employ more
                    diversified, innovative, and integrated thinking and
                    applications within our industry. Gazing back towards the
                    beginning of what is now an eleven year journey, we have
                    yearned to establish and integrate a core and fundamental
                    pillar that will be routed from the innovation of
                  ...
                  <p className='text-grey fs-3 my-4 lead'>
                    ...
                    pleasant emotions for hundreds of satisfied clients. Our
                    proven results have helped us groom and expand our
                    organizational interests into a &quot;One Stop Shop&quot;
                    where we endeavor to echo our customer excentric values
                    through our vast vendor networks and delivery of quality
                    products that fulfil the needs of a variety of projects
                    alike. This allowance created opportunities to fill market
                    requirements that solved both domestic and commercial
                    installation issues such as: basic electrics, access control
                    (Intercom, gate, &amp; garage, motors), CCTV Cameras, &amp;
                  ...
                  <p className='text-grey fs-3 my-4 lead'>
                    ...
                    situated in the{' '}
                    <span className='text-orange'>Northern Cape</span>.
                  </p>
                </div>
              </Col>
            </Row>
